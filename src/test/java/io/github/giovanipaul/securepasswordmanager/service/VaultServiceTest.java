...
class VaultServiceTest {
	...
	void rejectsBlankRequiredFields() {
		...
		assertEquals("Service name cannot be empty.",
				assertThrows(IllegalArgumentException.class, () -> service.add(vault, " ", "user", "ValidPass1!", ""))
						.getMessage());
		assertThrows(IllegalArgumentException.class, () -> service.add(vault, "Example", " ", "ValidPass1!", ""));
		assertThrows(IllegalArgumentException.class, () -> service.add(vault, "Example", "user", " ", ""));
	}
	...
	void rejectsDuplicateServiceAndUsernameIgnoringCase() {
		...
		assertThrows(IllegalArgumentException.class, () -> service.add(vault, "example", "user", "AnotherPass2!", ""));
	}
